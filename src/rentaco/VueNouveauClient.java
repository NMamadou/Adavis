...
public class VueNouveauClient extends JPanel implements ActionListener {
	...
	//private JLabel boxNom = new JLabel("Nom : ");
	//private JLabel boxPrenom = new JLabel("Prénom : ");
	//private JLabel boxMobile = new JLabel("Mobile : ");
	...
	public void actionPerformed(ActionEvent evenement) {
		...
		if(sourceEvt == this.bEnregistrer){
			...
			//this.modele.ajouterClient(tfNom.getText() , tfPrenom.getText() , tfMobile.getText());
		}
